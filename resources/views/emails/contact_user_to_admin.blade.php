                            ...
                            <tbody style="width: 100%;display: inline-table;background: #f2f9ff;border-radius: 20px;">
                                ...
                                <tr>
                                    <td style="font-size: 14px; text-align: left; line-height: 24px;padding: 30px;">                                        
                                        ...
                                        <p style="margin-bottom: 5px;margin-top: 0">We have a new inquiry from the website's contact form.</p>
                                        <p style="margin-bottom: 15px;margin-top: 0">Please check the details below - </p>
                                        <p>Name - <span style="font-weight: 600">{{$name}}</span></p>
                                        <p>Region - <span style="font-weight: 600">{{$region}}</span></
                                        <p>Contact Number - <span style="font-weight: 600">{{$contact_number}}</span></p>
